package hgh.project.baemin_clone.data.response.address
...
data class AddressInfo(
    ...
    fun toSearchInfoEntity(locationLatLongEntity: LocationLatLongEntity) = MapSearchInfoEntity(
        fullAddress =fullAddress ?: "주소 정보 없음",
        name = buildingName ?: "빌딩 정보 없음",
        locationLatLong = locationLatLongEntity
    )
